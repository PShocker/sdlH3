...
static void drawBackGround() {
  ...
  auto oName = strPool[927 + ObjectType::WATERING_HOLE];
...
static void drawButton() {
  ...
  AdvMapSys::drawButtons(leftUp.x, leftUp.y, top, WaterHoleSys::buttons);
}
...
bool WaterHoleSys::leftMouseUp(float x, float y) {
  ...
  if (AdvMapSys::clickButtons(leftUp.x, leftUp.y, WaterHoleSys::buttons, clickType)) {
    return false;
  }
  return true;
}
