...
static void drawBackGround() {
  ...
  auto oName = strPool[927 + ObjectType::OASIS];
...
static void drawButton() {
  ...
  AdvMapSys::drawButtons(leftUp.x, leftUp.y, top, PandoraSys::buttons);
}
...
bool PandoraSys::leftMouseUp(float x, float y) {
  ...
  if (AdvMapSys::clickButtons(leftUp.x, leftUp.y, PandoraSys::buttons,
                              clickType)) {
    return false;
  }
  return true;
