...
static void drawButton() {
  ...
  AdvMapSys::drawButtons(leftUp.x, leftUp.y, top, MagSpringSys::buttons);
}
...
bool MagSpringSys::leftMouseUp(float x, float y) {
  ...
  if (AdvMapSys::clickButtons(leftUp.x, leftUp.y, MagSpringSys::buttons,
                              clickType)) {
    return false;
  }
  return true;
