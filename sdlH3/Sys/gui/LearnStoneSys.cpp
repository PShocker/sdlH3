...
static void drawBackGround() {
  ...
  auto oName = strPool[927 + ObjectType::TREE_OF_KNOWLEDGE];
...
static void drawButton() {
  ...
  AdvMapSys::drawButtons(leftUp.x, leftUp.y, top, LearnStoneSys::buttons);
}
...
bool LearnStoneSys::leftMouseUp(float x, float y) {
  ...
  if (AdvMapSys::clickButtons(leftUp.x, leftUp.y, LearnStoneSys::buttons,
                              clickType)) {
    return false;
  }
  return true;
