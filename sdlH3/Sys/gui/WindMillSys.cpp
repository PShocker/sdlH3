...
static void drawBackGround() {
  ...
  auto oName = strPool[927 + ObjectType::WINDMILL];
...
static void drawButton() {
  ...
  AdvMapSys::drawButtons(leftUp.x, leftUp.y, top, WindMillSys::buttons);
}
...
bool WindMillSys::leftMouseUp(float x, float y) {
  ...
  if (AdvMapSys::clickButtons(leftUp.x, leftUp.y, WindMillSys::buttons,
                              clickType)) {
    return false;
  }
  return true;
