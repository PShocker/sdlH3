...
void loadPcx() {
  const auto loadCommon = []() {
    const std::vector<std::string> filePaths = {
        "CRBKGCAS.pcx", "TPCAINFO.pcx", "ThCsMAG1.pcx", "ThCsMAG2.pcx",
        "ThCsMAG3.pcx", "ThCsMAG4.pcx", "ThCsTAV1.pcx", "ThCsDock.pcx",
        "ThCsCAS1.pcx", "ThCsCAS2.pcx", "ThCsCAS3.pcx", "ThCsHal1.pcx",
        "ThCsHal2.pcx", "ThCsHal3.pcx", "ThCsHal4.pcx", "ThCsMRK1.pcx",
        "ThCsMRK2.pcx", "ThCsBLAK.pcx", "ThCsLite.pcx", "ThCsGR1H.pcx",
        "ThCsGR2H.pcx", "ThCsCv2S.pcx", "ThCsTAV2.pcx", "ThCsHOLY.pcx",
