...
void loadPcx() {
  const auto loadCommon = []() {
    const std::vector<std::string> filePaths = {
        "TPCAINFO.pcx", "ThCsMAG1.pcx", "ThCsMAG2.pcx", "ThCsMAG3.pcx",
        "ThCsMAG4.pcx", "ThCsTAV1.pcx", "ThCsDock.pcx", "ThCsCAS1.pcx",
        "ThCsCAS2.pcx", "ThCsCAS3.pcx", "ThCsHal1.pcx", "ThCsHal2.pcx",
        "ThCsHal3.pcx", "ThCsHal4.pcx", "ThCsMRK1.pcx", "ThCsMRK2.pcx",
        "ThCsBLAK.pcx", "ThCsLite.pcx", "ThCsGR1H.pcx", "ThCsGR2H.pcx",
        "ThCsCv2S.pcx", "ThCsTAV2.pcx", "ThCsHOLY.pcx", "ThCsPIK1.pcx",
        "ThCsCRS1.pcx", "ThCsGR1.pcx", "ThCsSWD1.pcx", "ThCsMON1.pcx",
        "ThCsCv1.pcx", "ThCsANG1.pcx", "ThCsPIK2.pcx", "ThCsCRS2.pcx",
        "ThCsGR2.pcx", "ThCsSWD2.pcx", "ThCsMON2.pcx", "ThCsCV2.pcx",
        "ThCsANG2.pcx", "ThCsAng1.PCX", "TPMAGECS.pcx", "TPMAGE.pcx",
        "VWorld.pcx", "univbldg.pcx", "TPCASNEU.pcx", "PUZZLOGO.pcx",
        "PUZCAS00.pcx", "PUZCAS01.pcx", "PUZCAS02.pcx", "PUZCAS03.pcx",
        "PUZCAS04.pcx", "PUZCAS05.pcx", "PUZCAS06.pcx", "PUZCAS07.pcx",
        "PUZCAS08.pcx", "PUZCAS09.pcx", "PUZCAS10.pcx", "PUZCAS11.pcx",
        "PUZCAS12.pcx", "PUZCAS13.pcx", "PUZCAS14.pcx", "PUZCAS15.pcx",
        "PUZCAS16.pcx", "PUZCAS17.pcx", "PUZCAS18.pcx", "PUZCAS19.pcx",
        "PUZCAS20.pcx", "PUZCAS21.pcx", "PUZCAS22.pcx", "PUZCAS23.pcx",
        "PUZCAS24.pcx", "PUZCAS25.pcx", "PUZCAS26.pcx", "PUZCAS27.pcx",
        "PUZCAS28.pcx", "PUZCAS29.pcx", "PUZCAS30.pcx", "PUZCAS31.pcx",
        "PUZCAS32.pcx", "PUZCAS33.pcx", "PUZCAS34.pcx", "PUZCAS35.pcx",
        "PUZCAS36.pcx", "PUZCAS37.pcx", "PUZCAS38.pcx", "PUZCAS39.pcx",
        "PUZCAS40.pcx", "PUZCAS41.pcx", "PUZCAS42.pcx", "PUZCAS43.pcx",
        "PUZCAS44.pcx", "PUZCAS45.pcx", "PUZCAS46.pcx", "PUZCAS47.pcx",
...
void loadDef() {
  const auto loadCommon = []() {
    const std::vector<std::string> filePaths = {
        "ITMTL.def",          "itmcl.def",          "AVA0001.def",
        "AvWPike.def",        "TPMAGE1.DEF",        "AVXwhrl0.def",
        "AVLr15r0.def",       "AVLskul0.def",       "AVLr08r0.def",
        "AVLsh2r0.def",       "AVLroug2.def",       "AVLr07r0.def",
        "AVLr02r0.def",       "AVLr11r0.def",       "AVLr10r0.def",
        "AVLr14r0.def",       "AVLyuc30.def",       "AVLyuc20.def",
        "AVLyuc10.def",       "AVLroug1.def",       "AvLRR05.def",
        "AVLroug0.def",       "AVLman10.def",       "AVLmtgn1.def",
        "AVLlk3g0.def",       "AVLmd3r0.def",       "AVLPNTR0.def",
        "AvLRG04.def",        "AvLRG01.def",        "AvLRG08.def",
        "AVLmtgn5.def",       "AVLman40.def",       "AVLf03g0.def",
        "AvLRG06.def",        "AVLsh2g0.def",       "AvLRG09.def",
        "AVLfl6d0.def",       "AVLsh4g0.def",       "AvLRG05.def",
        "AvLRG02.def",        "AVLf06g0.def",       "AVLf12g0.def",
        "AVLf08g0.def",       "AVLPNTR4.def",       "AVLmtgn2.def",
        "AVLmtgn3.def",       "AVLmtgn4.def",       "AVLman30.def",
        "AVWmon5.def",        "AVWmon7.def",        "AVWmon6.def",
        "AVWmon3.def",        "AVWmon4.def",        "AVLmtgr4.def",
        "AVLmtgr6.def",       "AVLmtgr5.def",       "AVXwelr0.def",
        "AVSfntn0.def",       "AVTrndm0.def",       "AVArnd1.def",
        "AVArnd2.def",        "AVArnd4.def",        "AVArnd3.def",
        "AvXDenT.def",        "AVSgrdn0.def",       "avlsh7r0.def",
        "AVTwagn0.def",       "AVXmags0.def",       "AVLf09g0.def",
        "AVLf10g0.def",       "AVLmd2g0.def",       "AVLf11g0.def",
        "AVLf07g0.def",       "avlsh8r0.def",       "AVLca2r0.def",
        "avlsh4r0.def",       "avlsh5r0.def",       "avlsh9r0.def",
        "avlsh3r0.def",       "AVLca1r0.def",       "AVLct1r0.def",
        "AVLct3r0.def",       "avlsh6r0.def",       "avlsh1r0.def",
        "avlsh2r0.def",       "AVLsh1r0.def",       "ICN6432.def",
        "AVLsh3r0.def",       "AVLoc3g0.def",       "AVLSPTR5.def",
        "AVLSPTR1.def",       "AVLSPTR2.def",       "AVLSPTR0.def",
        "AVLsh6g0.def",       "AVLSPTR6.def",       "AVLSPTR4.def",
        "AVLSPTR3.def",       "AVLoc1g0.def",       "AVLoc2g0.def",
        "AVLct6g0.def",       "AVLct5g0.def",       "AVLct4g0.def",
        "AVLct2g0.def",       "AVLctrg0.def",       "avlmtrf6.def",
        "avlmtrf3.def",       "avlmtrf4.def",       "avlmtrf2.def",
        "avlmtrf5.def",       "avlmtrf1.def",       "AVSaxis0.def",
        "AVXpost0.def",       "IAM012.DEF",         "IAM013.DEF",
        "IAM014.DEF",         "IAM015.DEF",         "SpellBon.def",
        "OVBUTN3.def",        "OVBUTN1.def",        "OVBUTN6.def",
        "OVBUTN4.def",        "OVMINES.def",        "OVSLOT.def",
        "AVXmaps0.def",       "AVGrefg0.def",       "SMBAL.DEF",
        "SMTENT.DEF",         "SMCART.DEF",         "AVGsieg0.def",
        "avxfgld.def",        "ALTARMY.DEF",        "ALTSACR.DEF",
        "ALTART.DEF",         "ALTSACC.DEF",        "AvXAltar.def",
        "ALTSACR.DEF",        "ALTFILL.DEF",        "ALTEMBK.DEF",
        "iGPCrDiv.def",       "TPMRKBU1.DEF",       "TPMRKBU3.DEF",
        "TPMRKBU2.DEF",       "TPMRKBU4.DEF",       "TPMRKBU5.DEF",
        "TPMRKB.DEF",         "AvXOblK.def",        "AvXOblG.def",
        "AVMlean0.def",       "AVSclvg0.def",       "APHLF1G.def",
        "APHLF1Y.def",        "APHLF1R.def",        "AVXhild0.def",
        "AVXmerm0.def",       "AVXsirn0.def",       "AVAflot0.def",
        "AVXhutm0.def",       "AVXeyem0.def",       "AVXstbl0.def",
        "AVSlibr0.def",       "AVSmerc0.def",       "AVXl1sh0.def",
        "AVXl2sh0.def",       "SpellScr.def",       "AVXl3sh0.def",
        "AVSarna0.def",       "AVXsanc0.def",       "AVXgyne0.def",
        "AVXseeb0.def",       "AVStmpl0.def",       "AVXfyth0.def",
        "AvSMarl.def",        "AVXskds0.def",       "adcfra.def",
        "AVSring0.def",       "AvXRedW.def",        "imrl82.def",
        "AVXrlly0.def",       "ilck82.def",         "AVSidol0.def",
        "AVSgzbo0.def",       "AVSschm0.def",       "AVSwar20.def",
        "AVXmn2o0.def",       "AVXmx1b0.def",       "AVXmn1b0.def",
        "AVXmn2g0.def",       "AVSwtch0.def",       "AVXprsn0.def",
        "AVXtrek0.def",       "AVXschl0.def",       "IVIEWCR2.DEF",
        "IViewCr.DEF",        "CPKMAN.DEF",         "CHALBD.DEF",
        "CLCBOW.DEF",         "CHCBOW.DEF",         "CGRIFF.DEF",
        "CRGRIF.DEF",         "CSWORD.DEF",         "CCRUSD.DEF",
        "CMONKK.DEF",         "CZEALT.DEF",         "CCAVLR.DEF",
        "CCHAMP.DEF",         "CANGEL.DEF",         "CRANGL.DEF",
        "TBCSEXT2.def",       "TBCSMAGE.def",       "TBCSMAG2.def",
        "TBCSMAG3.def",       "TBCSMAG4.def",       "TBCSTVRN.def",
        "TBCSDOCK.def",       "TBCSCSTL.def",       "TBCSCAS2.def",
        "TBCSCAS3.def",       "TBCSHALL.def",       "TBCSHAL2.def",
        "TBCSHAL3.def",       "TBCSHAL4.def",       "TBCSMARK.def",
        "TBCSSILO.def",       "TBCSBLAK.def",       "TBCSSPEC.def",
        "TBCSHRD1.def",       "TBCSHRD2.def",       "TBCSBOAT.def",
        "TBCSEXT0.def",       "TBCSEXT1.def",       "TBCSHOLY.def",
        "TBCSDW_0.def",       "TBCSDW_1.def",       "TBCSDW_2.def",
        "TBCSDW_3.def",       "TBCSDW_4.def",       "TBCSDW_5.def",
        "TBCSDW_6.def",       "TBCSUP_0.def",       "TBCSUP_1.def",
        "TBCSUP_2.def",       "TBCSUP_3.def",       "TBCSUP_4.def",
        "TBCSUP_5.def",       "TBCSUP_6.def",       "TBRMEXT2.def",
        "TBRMMAGE.def",       "TBRMMAG2.def",       "TBRMMAG3.def",
        "TBRMMAG4.def",       "TBRMMAG5.def",       "TBRMTVRN.def",
        "TBRMCSTL.def",       "TBRMCAS2.def",       "TBRMCAS3.def",
        "TBRMHALL.def",       "TBRMHAL2.def",       "TBRMHAL3.def",
        "TBRMHAL4.def",       "TBRMMARK.def",       "TBRMSILO.def",
        "TBRMBLAK.def",       "TBRMSPEC.def",       "TBRMEXT0.def",
        "TBRMEXT1.def",       "TBRMHOLY.def",       "TBRMEXT3.def",
        "TBRMEXT4.def",       "TBRMEXT5.def",       "TBRMHRD1.def",
        "TBRMHRD2.def",       "TBRMHRD3.def",       "TBRMHRD4.def",
        "TBRMDW_0.def",       "TBRMDW_1.def",       "TBRMDW_2.def",
        "TBRMDW_3.def",       "TBRMDW_4.def",       "TBRMDW_5.def",
        "TBRMDW_6.def",       "TBRMUP_0.def",       "TBRMUP_1.def",
        "TBRMUP_2.def",       "TBRMUP_3.def",       "TBRMUP_4.def",
        "TBRMUP_5.def",       "TBRMUP_6.def",       "AH00_.def",
        "AH01_.def",          "AH02_.def",          "AH03_.def",
        "AH04_.def",          "AH05_.def",          "AH06_.def",
        "AH07_.def",          "AH08_.def",          "AH09_.def",
        "AH10_.def",          "AH11_.def",          "AH12_.def",
        "AH13_.def",          "AH14_.def",          "AH15_.def",
        "AH16_.def",          "AH17_.def",          "AF00.def",
        "AF01.def",           "AF02.def",           "AF03.def",
        "AF04.def",           "AF05.def",           "AF06.def",
        "AF07.def",           "ABF01L.def",         "ABF01G.def",
        "ABF01R.def",         "ABF01D.def",         "ABF01B.def",
        "ABF01P.def",         "ABF01W.def",         "ABF01K.def",
        "ABF02L.def",         "ABF02G.def",         "ABF02R.def",
        "ABF02D.def",         "ABF02B.def",         "ABF02P.def",
        "ABF02W.def",         "ABF02K.def",         "ABF03L.def",
        "ABF03G.def",         "ABF03R.def",         "ABF03D.def",
        "ABF03B.def",         "ABF03P.def",         "ABF03W.def",
        "ABF03K.def",         "AVWmrnd0.def",       "AVLholg0.def",
        "AvTCave.def",        "AVXboat2.def",       "AVWpikx0.def",
        "AVTgems0.def",       "AVTore0.def",        "AVA0014.def",
        "AVA0011.def",        "AVA0008.def",        "AVA0007.def",
        "AvWMonk.def",        "AVXccht0.def",       "AVLdead7.def",
        "AVMwndd0.def",       "AVTcrys0.def",       "AVTsulf0.def",
        "AVTgold0.def",       "AVXboat0.def",       "AVXboat1.def",
        "AVTchst0.def",       "AVSuniv0.def",       "AVA0128.def",
        "AVXtvrn0.def",       "AVXtomb0.def",       "AVXmktb0.def",
        "AVMwwhl0.def",       "AVWpegx0.def",       "agemLL.def",
        "agemLR.def",         "agemUL.def",         "agemUR.def",
        "IMOBIL.def",         "IMANA.def",          "ADVVIEW.DEF",
        "ADVPUZ.DEF",         "ADVDIG.DEF",         "ADVINFO.DEF",
        "ADVTURN.DEF",        "IOK6432.DEF",        "SYSOPB1.DEF",
        "SYSOPB2.DEF",        "SYSOPB3.DEF",        "SYSOPB4.DEF",
        "SYSOPB5.DEF",        "SYSOPB6.DEF",        "SYSOPB7.DEF",
        "SYSOPB8.DEF",        "SYSOPB9.DEF",        "SYSOB10.DEF",
        "SYSOB11.DEF",        "SYSOB12.DEF",        "SYSOB13.DEF",
        "SYSOPCHK.DEF",       "SOLOAD.DEF",         "SOSAVE.DEF",
        "SORSTRT.DEF",        "SOMAIN.DEF",         "soquit.DEF",
        "soretrn.DEF",        "CRADVNTR.def",       "ITPA.DEF",
        "SpelTab.DEF",        "Spells.DEF",         "SplevA.DEF",
        "SplevF.DEF",         "SplevW.DEF",         "SplevE.DEF",
        "hsbtns3.def",        "hsbtns5.def",        "UN32.def",
        "UN44.def",           "ITMCLS.def",         "ITMTLS.def",
        "itpt.def",           "OVBUTN4.def",        "IBY6432.DEF",
        "ICANCEL.DEF",        "IRCBTNS.DEF",        "IDV6432.DEF",
        "PSKIL32.def",        "PSKIL32.def",        "PSKIL42.def",
        "PSKILL.def",         "SECSK32.def",        "SECSK32.def",
        "SECSKILL.def",       "SECSK82.def",        "SMALRES.def",
        "RESOURCE.def",       "RESOURCE.def",       "RESOUR82.def",
        "CPRSMALL.def",       "CPRSMALL.def",       "CPRSMALL.def",
        "TWCRPORT.def",       "Artifact.def",       "Artifact.def",
        "Artifact.def",       "Artifact.def",       "SpellInt.def",
        "SpellInt.def",       "SpellInt.def",       "SPELLSCR.def",
        "IMRL22.def",         "IMRL30.def",         "IMRL42.def",
        "imrl82.def",         "ILCK22.def",         "ILCK30.def",
        "ILCK42.def",         "ilck82.def",         "PortraitsSmall.def",
        "PortraitsSmall.def", "PortraitsSmall.def", "PortraitsLarge.def",
        "CREST58.def",        "CREST58.def",        "CREST58.def",
        "CREST58.def",        "iOKAY.def",          "IOKAY32.def",
        "IOK6432.def",        "CREST58.def",        "PSKIL42.def",
        "hsbtns.DEF",         "hsbtns4.DEF",        "hsbtns2.DEF",
        "hsbtns6.DEF",        "hsbtns7.DEF",        "hsbtns8.DEF",
        "hsbtns9.DEF",        "tsbtns.def",         "TPTAV01.DEF",
        "TPTAV02.DEF"};
