...
struct CreatureCfg {
  ...
  const static inline std::unordered_map<std::string, uint16_t> creatureIndex =
      {{"pikeman", 0},         {"halberdier", 1},     {"archer", 2},
       {"marksman", 3},        {"griffin", 4},        {"royalGriffin", 5},
       {"swordsman", 6},       {"crusader", 7},       {"monk", 8},
       {"zealot", 9},          {"cavalier", 10},      {"champion", 11},
       {"angel", 12},          {"archangel", 13},     {"centaur", 14},
       {"centaurCaptain", 15}, {"dwarf", 16},         {"battleDwarf", 17},
       {"woodElf", 18},        {"grandElf", 19},      {"pegasus", 20},
       {"silverPegasus", 21},  {"dendroidGuard", 22}, {"dendroidSoldier", 23},
       {"unicorn", 24},        {"warUnicorn", 25},    {"greenDragon", 26},
       {"goldDragon", 27}};
