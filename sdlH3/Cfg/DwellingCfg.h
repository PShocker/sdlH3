  ...
  const static inline std::vector<std::vector<uint16_t>> dweCreature[] = {
      {
          ...
          {(uint16_t)CreatureCfg::Creature::EARTH_ELEMENTAL},   // 13: earthConflux
          ...
          {(uint16_t)CreatureCfg::Creature::DENDROID_GUARD},    // 45: dendroidArches
          {(uint16_t)CreatureCfg::Creature::TROGLODYTE},        // 46: warren
          {(uint16_t)CreatureCfg::Creature::WATER_ELEMENTAL},   // 47: waterConflux
          ...
          {(uint16_t)CreatureCfg::Creature::PSYCHIC_ELEMENTAL}, // 60: altarOfThought
          {(uint16_t)CreatureCfg::Creature::FIREBIRD},          // 61: pyre
          {(uint16_t)CreatureCfg::Creature::AZURE_DRAGON},      // 62: frozenCliffs
          {(uint16_t)CreatureCfg::Creature::CRYSTAL_DRAGON},    // 63: crystalCavern
          ...
          {(uint16_t)CreatureCfg::Creature::EARTH_ELEMENTAL},   // 70: altarOfEarth
          {(uint16_t)CreatureCfg::Creature::FIRE_ELEMENTAL},    // 71: altarOfFire
          {(uint16_t)CreatureCfg::Creature::WATER_ELEMENTAL},   // 72: altarOfWater
